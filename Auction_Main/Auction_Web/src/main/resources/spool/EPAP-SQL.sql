...
INSERT INTO `announcement` VALUES (1,1,1,'منصة إباب نقلة نوعية للقطاع الزراعي ***','2020-03-07 00:09:00.000000', '2020-03-07 00:09:00.000000');
INSERT INTO `announcement` VALUES (2,1,1,'ترقبونا قريباً*** ','2020-03-07 00:09:00.000000', '2020-03-07 00:09:00.000000');
INSERT INTO `announcement` VALUES (3,1,1,'مرحباً بكم في منصة إباب ***','2020-03-07 00:09:00.000000', '2020-03-07 00:09:00.000000');
...
CREATE TABLE `auction_buyers` (
  ...
  `bid_updated_time` timestamp(6) NULL DEFAULT NULL,
...
CREATE TABLE `auction_sellers` (
  ...
  `reserved1` int(3) DEFAULT NULL,
  `reserved2` varchar(30) DEFAULT NULL,
  `offer_updated_time` timestamp(6) NULL DEFAULT NULL,
...
CREATE TABLE `purchase_invoice` (
  ...
  `seller_public_name` varchar(30) NOT NULL,
  `buyer_public_name` varchar(30) NOT NULL,
  `buyer_shipper_public_name` varchar(30) DEFAULT NULL,
...
CREATE TABLE `sales_notice` (
  ...
  `seller_public_name` varchar(30) NOT NULL,
  `buyer_public_name` varchar(30) NOT NULL,
  `seller_shipper_public_name` varchar(30) DEFAULT NULL,
...
-- Dump completed on 2020-02-20 10:37:15
