...
<c:if test="${ratingsLog.logId eq null}">
    <div class="modal-header">
        ...
        <h1 class="modal-title">  <spring:message code="rating.buyer.lbl"/></h1> 
        <spring:message code="rating.poor.lbl"/>  ,  <spring:message code="rating.excellent.lbl"/>
    </div>
</c:if>
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
<input type="hidden" id="accountSellerId" name="accountSellerId"  value="${sellerAccountId}" />
<input type="hidden" id="accountBuyerId" name="accountBuyerId"  value="${BuyeraAccountId}"/>
...
<c:choose>
    <c:when test="${ratingsLog.logId eq null}">
        ...
        <div class="modal-footer text-right">
            <button type="submit" class="btn btn-success btn-lg" id="buyerRate"> <i class="fa fa-check"></i>&nbsp;&nbsp;
            ...
            $(document).ready(function () {
                ...
                $('#buyerRate').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        url: (contextPath + "/bba/saveBuyerRate"),
                        success: function (result) {
                            $("#rateBuyerModel").modal("hide");
                        },
                        error: function (e) {
                            console.log(e);
                            $("#rateBuyerModel").modal("hide");
    ...
    <c:otherwise>
        <div class="modal-body">
            <div class="col-md-12 col-sm-12">
                <p class="f25 text-danger"> <spring:message code="rating.buyer.msg"/></p>
            </div>
            <div class="col-md-12 col-sm-12">
                <div class="form-group user-rating">
                    <div class="rating-bar">
