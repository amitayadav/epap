...
<div class="right_col" role="main">
  <ul class="breadcrumb">
    ...
    <li><spring:message code="menu.common.financialstatement"/></li>
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><spring:message code="shipper.financialstatement.heading.title"> </spring:message></h3>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_panel">
              <form action="${contextPath}/shtransaction/financialstatement" method="POST" id="userfinancialstatement" enctype="multipart/form-data">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                <div class="form-group">
                  <spring:message code="shipper.financialstatement.lbl.startDate" var="startDatePhl"/>
                  <spring:message code="shipper.financialstatement.lbl.endDate" var="endDatePhl"/>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table_dayauction" id="shipperAccountStatement">
                  <thead>
                    <tr>
                      ...
                      <th><spring:message code="shipper.accountstatement.lbl.transactionReferenceId"/></th>
                      <th><spring:message code="shipper.accountstatement.lbl.transactionProduct"/></th>
                      <th><spring:message code="shipper.accountstatement.lbl.transactionRevenus"/></th>
                      <th><spring:message code="shipper.accountstatement.lbl.transactionCommission"/></th>
                      <th><spring:message code="shipper.accountstatement.lbl.transactionVat"/></th>
                  ...
                  <tbody>
                   ...
                   <c:forEach items="${transactionList}" var="transaction" varStatus="status">
                      <tr>
                        ...
                        <td class="text-center">${transaction.referenceId eq 0 ?  "" : transaction.referenceId}</td>
                        <td>${transaction.product}</td>
                        <td class="text-center"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits = "2" value = '${transaction.total eq 0 ?  "" : transaction.total}'/></td>
                        <c:set var="Total" value="${Total+transaction.total}"/>
                        <td><!--  <script>document.write(${transaction.commission eq 0 ?  "" : transaction.commission}.toFixed(2))</script>--></td>
                        <c:set var="Commission" value="${Commission+ 0}"/>
                  ...
                  <tfoot>
                    <tr>
                      <th class="text-right" colspan="4"> <spring:message code="total"/>: </th>
...
<script type="text/javascript">
  $(document).ready(function() {
      window.history.pushState("object or string", "EPAP|Financialstatement", contextPath+" /shtransaction/financialStatement");
      //$('#datatable').DataTable();
		...
		var endDateVar =  '<c:out value="${endDate}"/>';
		 ...
		 $('#shipperAccountStatement').DataTable({
			   searching: false,
	            paging: false, 
	            info: false,
	            ordering: false,
      ...
      $("#userfinancialstatement").validate({
          ...
          messages: {
              "startDate": {
                  "required": '<spring:message code="shipper.financialstatement.validation.startDate.required"/>'
              },
              "endDate": {
                  "required": '<spring:message code="shipper.financialstatement.validation.endDate.required"/>'
              }
          },
