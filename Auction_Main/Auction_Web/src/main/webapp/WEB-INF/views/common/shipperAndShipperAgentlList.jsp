                            ...
                            <c:forEach items="${shipperAndShipperAgentList}" var="logDetail">
                                <c:if test="${not empty logDetail.accountProfileBean && not empty logDetail.accountProfileBean.accountId}">
                                    <tr>
                                        ...
                                        <td class="text-hightlight text-center">${logDetail.accountProfileBean.phoneNumber1}</td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer text-right">
              <!--<button type="button" class="text-hightlight btn btn-danger btn-lg" data-dismiss="modal"><spring:message code="btn.close"/></button>-->
...
<script type="text/javascript">
    $(document).ready(function () {
        window.history.pushState("object or string", "EPAP|ShipperList", contextPath + "/general/shipperList");
