...
<div class="right_col" role="main"> 
    <ul class="breadcrumb">
  	...
  	<!-- <span>
        ...
        <li class="todaydatetime">
          <!--<button  class="btn btn-success"  onclick="auctionSellerOfferRefrsh()" data-html="true" data-toggle="tooltip" data-placement="bottom" data-original-title="<spring:message code="auctionbidslist.li.title.refresh"/>"><i class="fa fa-refresh" aria-hidden="true"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;-->
          <button  style="background-color:transparent; border-radius:50%" onclick="auctionSellerOfferRefrsh()" data-html="true" data-toggle="tooltip" data-placement="bottom" data-original-title="<spring:message code="auctionbidslist.li.title.refresh"/>"><i class="fa fa-refresh fa-lg" aria-hidden="true"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="">
        ...
        <input type="hidden" id ="auctionSellersId" value="${auctionSellersBean.auctionSellersId}">
                                            ...
                                            <c:choose>
                                                <c:when test="${(not empty auctionSellersBean && not empty auctionSellersBean.auctionSellersId && auctionSellersBean.auctionSellersId > 0) &&
                                                      ...
                                                      <span id="offer-price-update" class="hidden"> 
                                                         <c:choose>  
                                                	 <c:when test="${(not empty auctionSellersBean && not empty auctionSellersBean.auctionSellersId && auctionSellersBean.auctionSellersId > 0) &&
                                                                 (OFFER_STATUS_RUNNING eq auctionSellersBean.sellerOfferStatus)}">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered table_offer" id="dailyAuctionDetails">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden">offerUpdatedTime</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
...
//var currentTimeInterval = 0;
    ...
    var  auctionSellerId= document.getElementById("auctionSellersId").value;
    var auctionBuyerBidsAndViewSellerOffer = null;
    var  auctionOfferBuyerId=null;
...
//                            return "<span id='offerPrice' class='text-bold text-dark blink_me'>" + json.offerPrice.toFixed(2) + "</span>";
                            return "<span id='offerPrice' class='text-bold text-dark'>" + json.offerPrice.toFixed(2) + "</span>";
                        } else {
...
//                    $("#offerDetailsModal .modal-title").text("<spring:message code='account.type.S'/>: <spring:message code='auctionofferlist.th.offerinfoandpictures'/>");
    ...
    function auctionSellerOfferRefrsh(){
