                                    ...
                                    <table id="datatable" class="table table-striped table-bordered table_offer" id="dailyAuctionDetails">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="80px"><spring:message code="auctionofferlist.th.offerqty"/></th>
                                                <th width="80px"><spring:message code="auctionofferlist.th.availableqty"/></th>
                                                <th class="hidden"><spring:message code="auctionofferlist.th.offerprice"/></th>
                                                <th width="80px"><spring:message code="auctionofferlist.th.offerprice"/></th>
                                                <th width="80px"><spring:message code="auctionofferlist.th.location"/></th>
...
<div class="modal fade" id="profileViewModel" tabindex="-1" role="dialog" aria-hidden="true">
...
//                    $("#offerDetailsModal .modal-title").text("<spring:message code='account.type.S'/>: <spring:message code='auctionofferlist.th.offerinfoandpictures'/>");
    ...
    <sec:authorize access = "hasRole('ROLE_SELLER') or hasRole('ROLE_SELLER_AGENT')" >
        ...
        $('#increasePrice, #decreasePrice').on('click', function () {
            $.ajax({
                type: "POST",
                async: false,
                cache: false,
