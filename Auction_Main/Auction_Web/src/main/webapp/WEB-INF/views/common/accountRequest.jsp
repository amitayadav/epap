...
<div class="right_col" role="main">
  <ul class="breadcrumb">
    ...
    <li><spring:message code="menu.common.accountrequests"/></li>
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><spring:message code="accountrequest.heading.title"> </spring:message></h3>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  window.history.pushState("object or string", "EPAP|AccountReguest", contextPath+ "/sbs/accountRequest");
  });
