...
<div class="right_col" role="main">
  <ul class="breadcrumb">
    ...
    <li><spring:message code="comments.h3.commentsmanagement"/></li>
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><spring:message code="comments.h3.commentsmanagement"/></h3>
            </div>
        </div>
        ...
        <div class="x_content">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x-title">
                            <%-- <h2><spring:message code="comments.h2.listofcomments"/></h2> --%>
                  ...
                  <form action="${contextPath}/admin/commentslist" name="commentForm" id="commentform_id" method="get">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <sec:authorize access="hasRole('ROLE_ADMIN_SUPERUSER')">
                                          <th><spring:message code="comments.th.departmentname"/></th>
                                        </sec:authorize>                                      
                                        ...
                                        <th><spring:message code="comments.th.feedback"/></th>
                                    </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${commentslist}" var="comment" varStatus="status">
                                        <tr>
                                         ...
                                         <c:choose>
                                             ...
                                             <td class="text-bold text-uppercase text-center">
                                            <button onclick="editStatus(${comment.commentId})"  class="btn btn-info btn-sm "> 
...
<div class="modal fade" id="editCommentModel" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                </button>
                <h4 class="modal-title"><spring:message code="comments.model.header"/> </h4>
            </div>
...
var NC_INBOX =" ${ENUM_CommentCodes.INBOX_ONLY.getStatus()}";
var NC_SENT =" ${ENUM_CommentCodes.SENT_ONLY.getStatus()}";
var NC_BOTH = "${ENUM_CommentCodes.BOTH.getStatus()}";
 
$(document).ready(function() {
	 window.history.pushState("object or string", "EPAP|Comment", contextPath+"/admin/commentsList");
  ...
  function addComment(){
   ...
   function editStatus(id){
	   $.ajax({
        ...
        async: false,
        cache: false,
        url: (contextPath+"/admin/editcomment/"+id),
        success: function(result) {
        	$("#editCommentModel .modal-body").empty().html(result);
        	$("#editCommentModel").modal({
        		show:true,
        		backdrop: 'static',
          	    keyboard: false
              });
        },error: function(e){
        	$("#editCommentModel .modal-body").empty().html(e);
        	$("#editCommentModel").modal({
        		show:true,
        		backdrop: 'static',
          	    keyboard: false
