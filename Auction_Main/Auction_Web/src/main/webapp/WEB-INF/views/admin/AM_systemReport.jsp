...
<div class="right_col" role="main">
  <ul class="breadcrumb">
    ...
    <li><spring:message code="menu.masters.systemreports"/></li>
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><spring:message code="systemreport.heading.title"> </spring:message></h3>
      </div>
    </div>
...
<script type="text/javascript">
  $(document).ready(function() {
	  window.history.pushState("object or string", "EPAP|SystemReports", contextPath+ "/spropt/report/systemReports");
