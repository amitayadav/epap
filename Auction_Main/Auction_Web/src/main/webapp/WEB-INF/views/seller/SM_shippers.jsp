  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><spring:message code="seller.shippers.heading.title"> </spring:message></h3>
      </div>
    </div>
 ...
 <%-- 	<div class="x_content">
      <div class="x_panel">
        <div class="table-responsive ">
          <table id="confirmDeliveryTable" class="table table-striped table-bordered">
            <thead>
              <tr>
                <th width="150px">Full Name</th>
                <th width="50px">Mobile No</th>
                <th width="50px">Vehicle</th>
                <th width="50px">Main Locations</th>
                <th width="50px">Rating</th>
              </tr>
            </thead>
            <tbody>
            <tr>
              <td>${loginDetailBean.accountProfileBean.fullName}</td>
              <td></td>
              <td></td>
              <td></td>
              <td></td>
