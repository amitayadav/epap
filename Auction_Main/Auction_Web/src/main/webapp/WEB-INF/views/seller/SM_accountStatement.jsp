...
<div class="right_col" role="main">
    <ul class="breadcrumb">
        ...
        <li><spring:message code="seller.financialstatement.title"/></li>
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><spring:message code="seller.financialstatement.title"/></h3>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_panel">
                            <form action="${contextPath}/stransaction/financialstatement" method="POST" id="userfinancialstatement" enctype="multipart/form-data">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                <div class="form-group">
                                    <spring:message code="seller.financialstatement.lbl.startDate" var="startDatePhl"/>
                                    <spring:message code="seller.financialstatement.lbl.endDate" var="endDatePhl"/>
                                ...
                                <!--fahad2: removed check for empty table-->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 ">
                        <div class="x_panel">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table_dayauction" id="sellerAccountStatement">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><spring:message code="seller.accountstatement.lbl.transactionCommission"/></th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${transactionList}" var="transaction" varStatus="status">
                                            <tr>
                                                <td width="230px"><fmt:formatDate pattern='EEEE dd MMMM yyyy - hh:mm:ss a' value="${transaction.transactionCreation}"/></td>
                                                <td width="380px">
                                                    ${transaction.transactionDescription}
                                                    <%-- <spring:message code="trcode.${transaction.transactionCodeBean.transactionCode}"/> --%>
                                                </td>
                                                <td class="text-center" width="50px">${transaction.referenceId eq 0 ?  "" : transaction.referenceId}</td>
                                                <td width="200px">${transaction.product}</td>
                                                <td class="text-center" width="60px"><fmt:formatNumber type="number" minFractionDigits="0" maxFractionDigits = "0" value ='${transaction.quantity eq 0 ?  "" : transaction.quantity}'/></td>
                                                <c:set var="Quantity" value="${Quantity+transaction.quantity}"/>
                                                <td class="text-center" width="60px"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits = "2" value ='${transaction.price eq 0 ?  "" : transaction.price}'/></td>
                                                ...
                                                <td class="text-center" width="60px"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits = "2" value ='${transaction.commission eq 0 ?  "" : transaction.commission}'/></td>
                                                <c:set var="Commission" value="${Commission+transaction.commission}"/>
                                                <td class="text-center" width="60px"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits = "2" value ='${transaction.vat eq 0 ?  "" : transaction.vat}'/></td>
                                                <c:set var="Vat" value="${Vat+transaction.vat}"/>
                                                <td class="text-center" width="60px"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits = "2" value ='${transaction.shipping eq 0 ?  "" : transaction.shipping}'/></td>
                                                <c:set var="Shipping" value="${Shipping+transaction.shipping}"/>
                                                <td class="text-center debit" width="90px">
                                                    <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits = "2" value = '${transaction.debit gt 0 ? transaction.debit : ""}'/> </td>
                                                <td class="text-center credit" width="90px">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <!--fahad: set total on right and values center-->
...
<script type="text/javascript">
    $(document).ready(function () {
        window.history.pushState("object or string", "EPAP|FinancialStatement", contextPath + "/stransaction/financialStatement");
        //$('#datatable').DataTable();
        ...
        $('#sellerAccountStatement').DataTable({
			   searching: false,
	            paging: false, 
	            info: false,
	            ordering: false,
        ...
        $("#userfinancialstatement").validate({
            ...
            messages: {
                "startDate": {
                    "required": '<spring:message code="seller.financialstatement.validation.startDate.required"/>'
                },
                "endDate": {
                    "required": '<spring:message code="seller.financialstatement.validation.endDate.required"/>'
                }
            },
