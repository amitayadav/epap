      ...
      <section class="login_content">
        ...
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
          ...
          <div>
            ...
            <!--fahad: increase size of Login text-->
            <input type="submit" id="formSubmit" class="btn btn-default submit" style="font-size:24px;" value='<spring:message code="login.btn.login"/>'/>
