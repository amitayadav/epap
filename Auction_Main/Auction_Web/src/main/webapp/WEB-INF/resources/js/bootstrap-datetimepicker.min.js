  ...
  g.prototype = {
    ...
    setStartDate: function(i) {
      ...
      if (this.startDate.valueOf() !== 8639968443048000) {
    	  if(Number.isInteger(this.timezone)){
    		  this.startDate = new Date(this.startDate.getUTCFullYear(), this.startDate.getUTCMonth(), this.startDate.getUTCDate(), (this.startDate.getUTCHours()+this.timezone), this.startDate.getUTCMinutes(), this.startDate.getUTCSeconds()); 
    	  }
    ...
    setEndDate: function(i) {
      ...
      if (this.endDate.valueOf() !== 8639968443048000) {
		if(Number.isInteger(this.timezone)){
		  this.endDate = new Date(this.endDate.getUTCFullYear(), this.endDate.getUTCMonth(), this.endDate.getUTCDate(), (this.endDate.getUTCHours()+this.timezone), this.endDate.getUTCMinutes(), this.endDate.getUTCSeconds()); 
		}
