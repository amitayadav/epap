...
@Controller
@RequestMapping("/spropt/auctions")
public class AuctionAdminSuperOperationController {
	...
	public String manageauction(Model model, @PathVariable(value = "auctionId", required = false) Integer auctionId) {
		logger.info("AuctionAdminSuperOperationController Call manageauction method");
	...
	public ModelAndView saveAuction(@ModelAttribute("dailyAuctionsBean") DailyAuctionsBean dailyAuctionsBean, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		logger.info("AuctionAdminSuperOperationController Call saveAuction method");
		String view = "/spropt/auctions/auctionlist";
	...
	public List<DailyAuctionsView> dailyAuctionViewList() {
		logger.info("AuctionAdminSuperOperationController Call dailyAuctionViewList method");
