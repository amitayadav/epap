...
@AssociationOverrides({ @AssociationOverride(name = "id.accountProfile", joinColumns = @JoinColumn(name = "seller_id")),

		@AssociationOverride(name = "id.transactionDate", joinColumns = @JoinColumn(name = "transaction_date")) })
public class SellerBalance implements java.io.Serializable {

	private static final long serialVersionUID = 1L;

	private SellerBalanceId id = new SellerBalanceId();
	...
	public SellerBalance(SellerBalanceId id) {
		super();
		this.id = id;
	}

	@EmbeddedId
	public SellerBalanceId getId() {
		return this.id;
	}

	public void setId(SellerBalanceId id) {
		this.id = id;
	}
